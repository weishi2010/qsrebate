...
//                product.setCommissionRatio(new BigDecimal(product.getCommissionRatio()).setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue());
//                //原价
...
//                product.setCommission(new BigDecimal(product.getCommission()).setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue());
