...
function getTemplate(product, tab) {
    ...
    // if (product.couponType == 2 && product.productCoupon) {
    //     "               htmlTemp +=   <a href=\"javascript:void(0);\" onclick=\"redirectJdPromotionCouponUrl(" + product.productId + ",'" + product.productCoupon.couponLink + "')\" class=\"share\">";
    // } else {
    //     "            htmlTemp +=      <a href=\"javascript:void(0);\" onclick=\"redirectJdPromotionUrl(" + product.productId + ")\" class=\"share\">";
    // }
